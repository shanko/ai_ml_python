...
if len(sys.argv) > 1:
    ...
    print(f"City was not passed as command line arg, so taking default city of {city}")

# **Run the Workflow**
user_query = f"What is the weather in {city}?"
user_query = """"It was 10am and Manus was getting ready to go to work. He had to catch the subway at Central Park Station and get down at Halstead. From there he had to take Bus number 145 which dropped him off at the Bentley Stadium. A quick walk off 15th street and Broadway and he was at his office in downtown Olathe. A total of 40 minutes of commute!"""
